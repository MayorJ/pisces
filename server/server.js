...
const app = express();
// const PORT = 3000; // Remove or comment out this line
...
            const link = `http://localhost:3000/blog.html?id=${blogPost.id}`; // Needs adjustment for production
            const picture = `http://localhost:3000${blogPost.img}`; // Needs adjustment for production
...
// Replace app.listen with the serverless handler
// app.listen(PORT, () => {
